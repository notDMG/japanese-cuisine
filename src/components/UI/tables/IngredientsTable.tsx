	...
	if (!isAuth) {
		return (
			<div className="w-min-80 mt-5 bg-white p-8 rounded-xl shadow-2xl border text-center">
				<p className="text-mist-400 font-medium">
					...
					>
						<div className="space-y-2 text-left">
							<div className="flex justify-between items-center pb-2">
								...
								<span className="text-gray-600 uppercase text-[14px]">
									{ingredient.name}
								</span>
							</div>
							...
							<div className="flex justify-between items-center pb-2">
								...
								<span className="text-gray-950 font-bold text-[16px] italic">
				...
				<table className="min-w-full divide-y divide-gray-200">
					<thead className="bg-gray-50 border-b border-orange-400">
						<tr>
							<th
								scope="col"
								className="text-black px-6 py-3 font-bold"
							>
								{siteConf.tableContent.name}
							</th>
							<th
					...
					<tbody className="divide-y divide-gray-200 bg-white">
						{ingredients.map(ingredient => (
							...
							>
								<td className="text-gray-500 px-6 py-4 whitespace-nowrap uppercase">
									{ingredient.name}
								</td>
								...
								<td className="text-gray-900 px-6 py-4 whitespace-nowrap font-semibold italic">
									{ingredient.pricePerUnit} $
								</td>
